...
$resultt = mysqli_query($conn,$queryy) or die();
...
//    $query = "SELECT * FROM songs WHERE name REGEXP '{$regex}' OR artist REGEXP '{$regex}' order by (name LIKE '%$strr%')  DESC LIMIT 50";
	...
	<tr>
	<td align='right' colspan='13' style='font-size:14px;background-color:#FFFFFF;'><img src='https://www.ringme.co.il/img/svg/search.svg' style='vertical-align:middle'> <b>חיפוש מהיר של צלצולים במערכת</b> • <font color='green'><b><u>לפי מספר</u></b></font> •</td>
	</tr>
