...
$aCode = (isset($_POST["CODE"]) && !empty($_POST["CODE"])) ? $_POST["CODE"] : '';
	switch ($aCode) {
		case '00':
			edit();
			break;
...
<td><input type='radio' name='off' value='0' class='forminput' style='border:0px' ";
		if ($row['send'] == 0) echo "checked";
		echo "> לא <input type='radio' name='off' value='1' class='forminput' style='border:0px' ";
		if ($row['send'] == 1) echo "checked";
		echo "> כן</td>	
</tr>
<tr>
<td style='font-size:12px'><b>כיבוי פרסומות קופצות - הורדה</b></td>
<td><input type='radio' name='offup' value='0' class='forminput' style='border:0px' ";
		if ($row['sendup'] == 0) echo "checked";
		echo "> לא <input type='radio' name='offup' value='1' class='forminput' style='border:0px' ";
		if ($row['sendup'] == 1) echo "checked";
		echo "> כן</td>	
</tr>
<tr>
<td style='font-size:12px'><b>כיבוי פרסומות קופצות - ספאם</b></td>
<td><input type='radio' name='offupa' value='0' class='forminput' style='border:0px' ";
		if ($row['sendupa'] == 0) echo "checked";
		echo "> לא <input type='radio' name='offupa' value='1' class='forminput' style='border:0px' ";
		if ($row['sendupa'] == 1) echo "checked";
		echo "> כן</td>	
</tr>
<tr>
<td style='font-size:12px'><b>כיבוי הבקשות</b></td>
<td><input type='radio' name='offs' value='0' class='forminput' style='border:0px' ";
		if ($row['sends'] == 0) echo "checked";
		echo "> לא <input type='radio' name='offs' value='1' class='forminput' style='border:0px' ";
		if ($row['sends'] == 1) echo "checked";
		echo "> כן</td>	
</tr>
<tr>
